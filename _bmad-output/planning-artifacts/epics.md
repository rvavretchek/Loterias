...
**E** pra +Milionária/Quina/Dupla-Sena, os campos de linha/coluna ficam indisponíveis até o grid oficial desses 3 ser confirmado (Deferred da arquitetura) — não aparecem como opção nem geram erro
