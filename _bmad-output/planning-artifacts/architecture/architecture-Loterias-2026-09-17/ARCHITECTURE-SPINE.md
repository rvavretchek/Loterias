...
apps/
  loterias_core/
    models.py           # + RULE_NAMES_BY_GAME (dict, ao lado de GAMES_CONFIG — fonte unica do enum de rule_name por Jogo, AD-11)
                         ...
                         #   CheckConstraint XOR numeric_value/choice_value — AD-11)
